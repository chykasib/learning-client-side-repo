        ...
        <Container className='mb-5'>
            ...
            <Accordion defaultActiveKey="0">
                <Accordion.Item eventKey="0">
                    ...
                    <Accordion.Body>
                        <h5 className='p-3'>Cross-Origin Resource Sharing (CORS) is a mechanism that uses additional HTTPheaders to tell a browser to let a web application running at one origin (domain) have permission to access selected resources from a server at a different origin.A web application makes a cross-origin HTTP request when it requests a resource that has a different origin (domain, protocol, and port) than its own origin.</h5>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="1">
                    ...
                    <Accordion.Body>
                        <h5 className='p-3'>Firebase helps you develop high-quality apps, grow your user base, and earn more money. Each feature works independently, and they work even better together.</h5>
                    </Accordion.Body>
                </Accordion.Item>
                <Accordion.Item eventKey="2">
                    ...
                    <Accordion.Body>
                        <h5 className='p-3'>Other ways to authenticate can be through cards, retina scans, voice recognition, and fingerprints.</h5>
                    </Accordion.Body>
                </Accordion.Item>
