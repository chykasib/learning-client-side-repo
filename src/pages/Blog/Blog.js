...
const Blog = () => {
  return (
    <Container className="mb-5">
      <h1 className="mb-5">
        <u>Some Questions And Answers</u>
      </h1>
      <Accordion defaultActiveKey="0">
        <Accordion.Item eventKey="0">
          <Accordion.Header>
            <h4>
              <b className="pe-3">Question 1:</b> What is cors?
            </h4>
          </Accordion.Header>
          <Accordion.Body>
        ...
        <Accordion.Item eventKey="1">
          <Accordion.Header>
            <h4>
              <b className="pe-3">Question 2:</b>Why are using firebase?
            </h4>
          </Accordion.Header>
          <Accordion.Body>
            <p className="p-3 text-start">
        ...
        <Accordion.Item eventKey="2">
          <Accordion.Header>
            <h4>
              <b className="pe-3">Question 3:</b> What others options do you
              have to implement authentication?
            </h4>
          </Accordion.Header>
          <Accordion.Body>
            <p className="p-3 text-start">
              Other ways to authenticate can be through cards, retina scans,
        ...
        <Accordion.Item eventKey="3">
          <Accordion.Header>
            <h4>
              <b className="pe-3">Question 4:</b> How does the private route
              work?
            </h4>
          </Accordion.Header>
          <Accordion.Body>
        ...
        <Accordion.Item eventKey="4">
          <Accordion.Header>
            <h4>
              <b className="pe-3">Question 5:</b> What is node?
            </h4>
          </Accordion.Header>
          <Accordion.Body>
            <p className="p-3 text-start">
        ...
        <Accordion.Item eventKey="5">
          <Accordion.Header>
            <h4>
              <b className="pe-3">Question 6:</b> How does node work?
            </h4>
          </Accordion.Header>
          <Accordion.Body>
            <p className="p-3 text-start">
